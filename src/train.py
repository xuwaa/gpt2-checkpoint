...
parser.add_argument('--run_name', type=str, default='large2', help='Run id. Name of subdirectory in checkpoint/ and samples/')
parser.add_argument('--run_name2', type=str, default='run2', help='Run id. Name of subdirectory in checkpoint/ and samples/')
...
def main():
    ...
    checkpoint_folder = "checkpoint/large2"  
    csv_file_path = "folder_info_log_774_2.csv"
            ...
            while True:
               ...
               # print("Number of GPUs available: ", len(physical_devices))
                ...
                if counter % args.save_every == 0:
                    file_del= os.path.join(CHECKPOINT_DIR, args.run_name2)
